...
echo "  │                                          │"
echo "  │  💡 mase init 自动部署规则到 7 款 AI 工具:  │"
echo "  │     .trae/rules/          (Trae IDE)     │"
echo "  │     .cursor/rules/        (Cursor IDE)   │"
echo "  │     .windsurf/rules/      (Windsurf IDE) │"
echo "  │     CLAUDE.md             (Claude Code)  │"
echo "  │     AGENTS.md             (OpenAI Codex) │"
echo "  │     CONVENTIONS.md        (Aider)        │"
echo "  │     .github/copilot-instructions.md      │"
echo "  │                        (GitHub Copilot)  │"
echo "  │     project-rules.md     (项目根目录兜底) │"
echo "  └──────────────────────────────────────────┘"
echo ""
